...
SECRET_KEY = 'r72h%zavzeb!_9@8t!wf^p6thuld*050zsz+#9up88*29@qk1m'
...
PROJECT_DIR, PROJECT_MODULE_NAME = os.path.split(
    os.path.dirname(os.path.realpath(projectbook.__file__))
)
...
ROOT_URLCONF = 'projectbook.conf.urls'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_DIR, PROJECT_MODULE_NAME, 'apps' , 'wall' , 'templates'),
