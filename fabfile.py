...
env.hosts = ['projectbook.dev.pixel.com']
env.root = '/opt/webapps/projectbook'
env.proj_root = env.root + '/src/projectbook'
...
def clone():
    ...
    with cd('%s/projectbook/conf/local' % env.proj_root):
